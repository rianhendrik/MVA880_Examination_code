...
n = 200;
*Null EM density;
pis_h0 = {0.2730945, 0.3103271, 0.4165785};
mus_h0 = {137.56819, 153.29601, 203.34284};
sigmas_h0 = {3.0408476, 6.5827824, 15.951026};

*kNN density;
pis_h1 = {0.315, 0.305, 0.38};
mus_h1 = {137.814, 151.183, 207.867};
sigmas_h1 = {3.5555677, 8.1641112, 13.549649};
